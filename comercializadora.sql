...
INSERT INTO `categorias` VALUES (1,'Panes'),(2,'Embutidos'),(11,'Pan'),(12,'HOLA'),(14,'AAAAAAAAAAAAAAAAAAAAAAAAAAAAA'),(15,'Prueba2'),(16,'Categoria modal'),(17,'hgioe'),(18,'Prueba');
...
DROP TABLE IF EXISTS `compra_temporal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `compra_temporal`
--

LOCK TABLES `compra_temporal` WRITE;
/*!40000 ALTER TABLE `compra_temporal` DISABLE KEYS */;
/*!40000 ALTER TABLE `compra_temporal` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`id_unidad`) REFERENCES `unidades` (`id`),
...
INSERT INTO `productos` VALUES (1,'102030','Chorizo',5200.00,15,1,1,'Chorizo con queso','Ranchera'),(2,'102032010','Pan Perro',3200.00,50,1,1,'Pan perro con sabor a queso','Bimbo');
...
INSERT INTO `unidades` VALUES (1,'Kilogramo','Kg');
...
-- Dump completed on 2022-10-05 18:35:04
